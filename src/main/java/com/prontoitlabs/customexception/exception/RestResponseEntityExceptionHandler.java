...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<RestResponse> handleUnknownException(Exception ex, WebRequest request) {
        ...
        return new ResponseEntity<RestResponse>(new RestResponse(Boolean.FALSE, ImmutableList.of(Constants.DEFAULT_ERROR_MESSAGE), null), HttpStatus.INTERNAL_SERVER_ERROR);
    }
